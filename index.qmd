...
There are 7 node clusters in the graph. We don't have information on the actual
users documented as I mentioned, but it would be interesting to see what kind of
topics are associated with each user and in a macro sense, each node cluster.
